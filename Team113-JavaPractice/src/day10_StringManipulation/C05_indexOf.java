...
public class C05_indexOf {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(str.indexOf("cok")); // 5, c'nin index'ini verir ve ilk karakter nereden baslar onu belirler
        ...
        // 4- aradiginiz kelime cumlede hic kullanilmammis

        String cumle = "Yasasin java, iyi ki java ogreniyorum";
        String kelime = "java";

        if (cumle.indexOf(kelime) == (-1)) {
            System.out.println("aradiginiz kelime cumlede hic kullanilmammis");
        } else  {
